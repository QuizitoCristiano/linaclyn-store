...
export default function AdminPedidos() {
    ...
    const [pedidos, setPedidos] = useState([
...

        {
            ...
            items: 2,
            metodo: "PIX",
            endereco: "Av. Paulista, 1000 - Bela Vista, São Paulo - SP", // CAMPO NOVO
            produtos: [ // CAMPO NOVO
    ...
    return (
        <div className="min-h-screen bg-zinc-50 dark:bg-[#0c0c0c] text-zinc-900 dark:text-zinc-200 p-4 md:p-8 pt-20 md:pt-24 font-sans transition-colors duration-300 overflow-x-hidden">
                                        ...
                                        <tr key={pedido.id} className="hover:bg-zinc-50 dark:hover:bg-zinc-800/10 transition-colors group">
                                            ...
                                            <td className="p-10 text-right">
                                                <div className="flex justify-end gap-3">
                                                    {/* AGORA EXECUTANDO A FUNÇÃO E PASSANDO O PEDIDO */}
                                                    <button
                                                    ...
                                                    <button title="Imprimir" className="w-10 h-10 rounded-xl bg-zinc-50 dark:bg-zinc-900 flex items-center justify-center text-zinc-400 hover:text-zinc-900 dark:hover:text-white border border-zinc-200 dark:border-zinc-800 transition-all">
            ...
            {/* O MODAL DEDICADO QUE CRIAMOS ACIMA */}
            <ModalDetalhesPedido
                isOpen={isModalOpen}
                setIsOpen={setIsModalOpen}
                pedido={pedidoSelecionado}
                onUpdateStatus={handleUpdateStatus} // ESSA LINHA É A CHAVE
            />
        </div>
    );
}